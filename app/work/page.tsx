const career = [
  {
    ...
    highlights: [
      ...
      { metric: "9M+ leads", label: "CRM migration (Zoho → Salesforce) across 8M+ customer records, 1800 users" },
  ...
  },
  {
    ...
    summary: "Nine years across planning, digital, strategy and client leadership. Managed portfolios up to ₹150 Cr. Built practices in branded content, digital strategy, audience analytics. Led through COVID for major retail brands.",
    highlights: [
      { metric: "9 years", label: "Progression from Media Manager to Sr. Director – Strategy" },
      { metric: "₹150 Cr", label: "Media portfolio managed; clients: Apollo Hospitals, Muthoot Finance, GRT, Max Fashion, Lifestyle" },
      { metric: "APAC Award", label: "Team of the Year — Mindshare APAC STP Awards (Landmark Group, COVID resilience)" },
      { metric: "Emvies Silver", label: "Best Digital Innovation — Durex World AIDS Day campaign" },
    ],
    tags: ["Brand Strategy", "Media Planning", "Content", "Digital", "Client Leadership"],
  },
  {
    period: "2009 — 2012",
